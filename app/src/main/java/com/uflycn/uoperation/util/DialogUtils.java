...
public class DialogUtils {
     ...
     * 重新提交请求
     *
     * @param listener 重新提交请求listener
     */
    public static void showRetryPostDialog(Context context, DialogInterface.OnClickListener listener) {
        showAlert(context, "提示", "数据提交失败!是否重新提交?",
                "重新提交", listener, "稍后自动提交", new DialogInterface.OnClickListener() {
                    @Override
     ...
     * @param listener 重新提交请求listener
     */
    public static void showRetryPostDialog(Context context, DialogInterface.OnClickListener listener, DialogInterface.OnClickListener cancleListener) {
        showAlert(context, "提示", "数据提交失败!是否重新提交?",
                "重新提交", listener, "稍后自动提交", cancleListener);
    }
}
