...
public class CrossRegisterActivity extends Activity {
    ...
    public static Intent newInstance(Context context){
        return new Intent(context,CrossRegisterActivity.class);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_cross_register);
        ...
        mCrossTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mSecondLevelAdapter == null) {
                    mSecondLevelAdapter = new CrossTypeAdapter(secondLevels, CrossRegisterActivity.this, R.layout.item_text_spinner);
    ...
    private void refreshTower(Tower tower) {
        ...
        if (MyApplication.registeredTower.equals(MyApplication.nearSecondTower)){
            return;
        }
