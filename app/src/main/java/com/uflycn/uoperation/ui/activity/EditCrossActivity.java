...
public class EditCrossActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    public static Intent newInstance(Context context, LineCrossEntity entity) {
        Intent intent = new Intent(context, EditCrossActivity.class);
        intent.putExtra("LineCrossEntity", entity);
        return intent;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_edit_cross);
    ...
    private void initCrossType() {
        ...
        mFirstLevelAdapter = new CrossTypeAdapter(firstLevel, this, R.layout.item_text_spinner);
        ...
        mSecondLevelAdapter = new CrossTypeAdapter(secondLevels, this, R.layout.item_text_spinner);
            ...
            public void onResponse(Call<BaseCallBack<String>> call, Response<BaseCallBack<String>> response) {
                if (response != null && response.body() != null && response.body().getCode() == 1) {
                    ...
                    if (mLineCrossEntity.getSysTaskId() != 0) {
                        ...
                        localBroadcastManager = LocalBroadcastManager.getInstance(EditCrossActivity.this);
