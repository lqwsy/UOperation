 ...
 */
public class SpinnerVcAdapter extends BaseAdapter implements SpinnerAdapter{
    private List<ItemDetail> mDatas;
    private Reference<Context> mContextRef;
    public SpinnerVcAdapter(List<ItemDetail> datas, Context context) {
        mDatas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textView.setText(mDatas.get(position).getItemsName());
        return convertView;
    }
    ...
    public  void onDataChange(List<ItemDetail> datas){
        mDatas = datas;
